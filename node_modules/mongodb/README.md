...
Create a new **server.js** file and add the following code to try out some basic CRUD
...
Run your server from the command line with:
...
Add to **server.js** the following function which uses the **insertMany**
